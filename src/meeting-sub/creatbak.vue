...
const userList = [
  { realName: '费斌', account: 'EW-1130' },
  { realName: '杨云云', account: 'EW-5029' },
  { realName: '姚永', account: 'EW-0264' },
  { realName: '杨玛丽', account: 'EW-1310' },
  { realName: '岳伟', account: 'EW-3781' },
  { realName: '苏秋叶', account: 'EW-4082' },
  { realName: '王威', account: 'EW-1232' },
  { realName: '何静', account: 'EW-1329' },
  { realName: '姚彩冰', account: 'EW-4643' },
  { realName: '王维真', account: 'EW-0068' },
  { realName: '林成志', account: 'EW-1097' },
  { realName: '刘经伟', account: 'EW-1982' },
  { realName: '姜剑', account: 'EW-0628' },
  { realName: '郭敏', account: 'EW-1847' },
  { realName: '曾伶俐', account: 'EW-6095' },
  { realName: '赵婷', account: 'EW-1993' },
  { realName: '甘亮', account: 'EW-0524' },
  { realName: '郝晓勇', account: 'EW-6242' },
  { realName: '曾闪林', account: 'EW-1977' },
  { realName: '周建峰', account: 'EW-2052' },
  { realName: '王成', account: 'EW-0831' },
  { realName: '李宁松', account: 'EW-0053' },
  { realName: '孙亚仓', account: 'EW-1429' },
  { realName: '黄秋明', account: 'EW-1472' },
  { realName: '肖凡', account: 'EW-1998' },
  { realName: '晏飞', account: 'YanFei' },
  { realName: '刘晖龙', account: 'EW-4726' },
  { realName: '曹达辉', account: 'EW-0204' },
  { realName: '陈宗钦', account: 'EW-1178' },
  { realName: '陈星', account: 'EW-1314' },
  { realName: '方娜', account: 'EW-1953' },
  { realName: '黄琪', account: 'EW-6364' },
  { realName: '肖兴', account: 'EW-0502' },
  { realName: '熊超', account: 'EW-1123' },
  { realName: '李军', account: 'EW-0520' },
  { realName: '张彦', account: 'EW-0587' },
  { realName: '夏志峰', account: 'EW-1189' },
  { realName: '刘建光', account: 'EW-1424' },
  { realName: '林伟奇', account: 'EW-1870' },
  { realName: '聂宏明', account: 'EW-3584' },
  { realName: '胡家福', account: 'EW-3766' },
  { realName: '李江', account: 'EW-4479' },
  { realName: '郭慧阳', account: 'EW-4334' },
  { realName: '熊顺刚', account: 'EW-5471' },
  { realName: '代新平', account: 'EW-6949' },
  { realName: '韦建全', account: 'EW-6399' },
  { realName: '邓飞', account: 'EW-6903' },
  { realName: '马剑', account: 'EW-4961' },
  { realName: '王亮', account: 'EW-6104' },
  { realName: '曹顺', account: 'EW-7361' },
  { realName: '毛斌斌', account: 'EW-7614' },
  { realName: '袁渊', account: 'EW-3282' },
  { realName: '陈西孟', account: 'EW-4770' },
  { realName: '张虎', account: 'EW-1076' },
  { realName: '荆紫乾', account: 'EW-2645' },
  { realName: '吴高社', account: 'EW-3067' },
  { realName: '许作明', account: 'EW-4090' },
  { realName: '钟超', account: 'EW-5031' },
  { realName: '朱行夕', account: 'EW-3517' },
  { realName: '陈杨', account: 'EW-6428' },
  { realName: '申梦喜', account: 'EW-6198' },
  { realName: '张洪彬', account: 'EW-5742' },
  { realName: '刘重杰', account: 'EW-5874' },
  { realName: '姚金光', account: 'EW-4448' },
  { realName: '赵永川', account: 'EW-4777' },
  { realName: '林培真', account: 'EW-0664' },
  { realName: '邬影影', account: 'EW-5750' },
  { realName: '易纯', account: 'EW-5924' },
]
const hostUser = [
  { realName: '费斌', account: 'EW-1130' },
  { realName: '杨云云', account: 'EW-5029' },
...
const meetingForm = reactive({
  ...
  users: userList as Array<{ realName: string, account: string }>,
  hostUser: hostUser as Array<{ realName: string, account: string }>,
  startTime: '',
  endTime: '',
  date: '',
  duration: '',
...
function applyMeetingToForm(data: MeetingInfoApi) {
  ...
  if (hostUsers.length) {
    ...
    meetingForm.hosts = data.settings?.hosts?.userid ?? meetingForm.hosts
